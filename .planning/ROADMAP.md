...
|----|-------|-----------------|--------------|--------|
| 01 | Foundation & design system | XcodeGen project, signing config, `DESIGN.md` tokens and components, Keychain-backed settings screen, smoke script | REQ-01, REQ-12, SC-05, SC-06 | pending |
